      ...
      <header className="w-full sticky top-0 z-40 bg-surface dark:bg-on-background border-b border-outline-variant/30 dark:border-outline/20 flex justify-between items-center px-margin-desktop py-4">
        <div className="flex items-center gap-8">
          ...
          <nav className="hidden md:flex gap-6">
            ...
            <Link className="font-label-lg text-label-lg text-primary dark:text-primary-fixed-dim font-bold border-b-2 border-primary" href="/media">Newsroom</Link>
            <Link className="font-label-lg text-label-lg text-on-surface-variant dark:text-surface-variant hover:bg-surface-container-low dark:hover:bg-surface-container-highest transition-colors cursor-pointer active:opacity-80 transition-all duration-200" href="/communities">Communities</Link>
          </nav>
        </div>
            ...
            <div className="md:col-span-2 border border-outline-variant/30 p-10 flex gap-8 items-center rounded-lg hover:bg-surface-container-low transition-colors group cursor-pointer">
              ...
              <div className="w-32 h-32 bg-primary-fixed rounded-full overflow-hidden flex-shrink-0 grayscale group-hover:grayscale-0 transition-all">
                <img 
                  ...
                  alt="Elara Vance"
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuBLggc37Tc48UlGUVFzDUOEe93RwhqWtQYkntSqIJbBE4WrVhUmZrl0vIceCXiN9ZVndIM6MNgMebBI3o__Npynhk4q7U7iceroisnrPB0axgqsT2oXiMvrxBM9btVHzteX2GalOnGwAvXp1P7Ir5TWNWhVggUilUvV93kYHv1VxcgE2w0RdYRS1pmOWpLkkAdqfjxn6_SySE_HTUusiFNWECVIrDtZ6egI82MAouPd5-gId_R6NaRnGCFZsyTgcXK2-29hTltvwKHQ0"
                />
              </div>
            </div>
          </div>
