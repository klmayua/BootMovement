    ...
    <PublicLayout>
      <div className="flex flex-col min-h-screen overflow-x-hidden">
        ...
        <section className="relative min-h-[870px] flex items-center overflow-hidden">
          <div className="absolute inset-0 z-0">
            <img 
              ...
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuBktre1t5gtk0LcsqiOsUVYs-OubN7wRk1GSv6y1lyAivhTVCjdh0T8iRu63McxGb_sc7lLTmWU9t1LeTkBAIwm5Z0NEMcf_rJig4DtF5RREJuyazi-qZEfJbZ1Hr6EBgmX63s4Tcoi7ulkS39F0mMOFIhz_s3tffqz1_SFJhQNOFjPNUxy3BAA2B1Jn6KoJ7_dzRsiQZKg09PP09-q3nuPOIFRE8uwQsh5t50JguujgmD9QgqG8xOVnjA2x4MG6p_poasX7Pk-1vYjI"
            ...
            <div className="relative z-10 max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop w-full grid md:grid-cols-2 gap-16 items-center py-20 md:py-0">
               <div className="text-white space-y-6 md:space-y-8 text-center md:text-left">
                 ...
                 <h1 className="font-display-lg leading-tight">
                   Traditional Values. <br/>
                   <span className="text-primary-fixed-dim">Future Progress.</span>
                 </h1>
                 <p className="font-body-lg text-on-surface-variant max-w-lg mx-auto md:mx-0">
                 ...
                 <div className="flex flex-col sm:flex-row justify-center md:justify-start gap-4 pt-4">
                   <button className="bg-secondary text-on-secondary px-8 py-4 rounded-full font-label-lg flex items-center justify-center gap-2 hover:translate-y-[-2px] transition-transform shadow-xl shadow-secondary/20 active:scale-95 touch-manipulation">
                       Join the Movement
                       <span className="material-symbols-outlined">arrow_forward</span>
                   </button>
                   <button className="border border-white/30 text-white px-8 py-4 rounded-full font-label-lg hover:bg-white/10 transition-all active:scale-95 touch-manipulation">
                       View Our Thesis
                   </button>
                 </div>
                 </div>
                    ...
                    <div className="bg-surface/5 backdrop-blur-md border border-white/10 p-8 rounded-xl">
                     ...
                     <div className="space-y-6">
                       <div className="space-y-2">
                         <div className="flex justify-between text-white font-label-lg">
                       ...
                       <div className="grid grid-cols-2 gap-4">
                         <div className="bg-primary/40 p-4 rounded-lg">
                           <p className="text-primary-fixed-dim font-label-md">Local Chapters</p>
                           <p className="text-white font-headline-sm">114</p>
                         </div>
                         <div className="bg-primary/40 p-4 rounded-lg">
                           <p className="text-primary-fixed-dim font-label-md">Active Campaigns</p>
                           <p className="text-white font-headline-sm">32</p>
                         </div>
                       </div>
                     </div>
                   </div>
        ...
        <section className="bg-primary py-20 text-white">
         ...
         {/* Call to Action */}
         <section className="py-24 md:py-32 bg-cream overflow-hidden relative">
           ...
           <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop relative z-10">
             <div className="max-w-2xl bg-white p-6 md:p-20 shadow-2xl shadow-primary/5 rounded-xl border-l-8 border-secondary">
               <h2 className="font-display-lg text-primary mb-6">The future is a choice we make together.</h2>
               ...
               <div className="flex flex-col sm:flex-row gap-4">
                 <button className="bg-secondary text-on-secondary px-10 py-5 rounded-full font-label-lg hover:brightness-110 shadow-lg shadow-secondary/30 transition-all active:scale-95 touch-manipulation">
                   Join the Movement
                 </button>
                 <button className="bg-primary text-white px-10 py-5 rounded-full font-label-lg hover:brightness-110 transition-all active:scale-95 touch-manipulation">
                   Donate to the Cause
                 </button>
               </div>
             </div>
