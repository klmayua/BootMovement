...
export default function HomePage() {
  return (
    <PublicLayout>
      <div className="bg-cream text-on-background selection:bg-secondary selection:text-white">
        <main>
          {/* Hero Section */}
          <section className="relative min-h-[870px] flex items-center overflow-hidden">
            <div className="absolute inset-0 z-0">
              ...
              />
              <div className="hero-gradient absolute inset-0 bg-[linear-gradient(rgba(0,45,28,0.85),rgba(0,45,28,0.95))]"></div>
            </div>
            <div className="relative z-10 max-w-container-max mx-auto px-margin-desktop grid md:grid-cols-2 gap-16 items-center">
              <div className="text-white space-y-8">
                ...
                <div className="flex flex-wrap gap-4 pt-4">
                  <button className="bg-secondary text-on-secondary px-8 py-4 rounded-full font-label-lg text-label-lg flex items-center gap-2 hover:translate-y-[-2px] transition-transform shadow-xl shadow-secondary/20 active:scale-95">
                    Join the Movement
                    <span className="material-symbols-outlined">arrow_forward</span>
                  </button>
                  <button className="border border-white/30 text-white px-8 py-4 rounded-full font-label-lg text-label-lg hover:bg-white/10 transition-all active:scale-95">
                    View Our Thesis
                  </button>
                </div>
              </div>
          ...
          <section className="py-24 bg-white">
            <div className="max-w-4xl mx-auto px-margin-mobile text-center space-y-8">
              <span className="material-symbols-outlined text-primary text-display-lg opacity-20" data-icon="format_quote">format_quote</span>
          ...
          <section className="py-24 px-margin-desktop max-w-container-max mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
              ...
              <Link href="/manifesto" className="font-label-lg text-label-lg text-primary flex items-center gap-2 group hover:text-secondary transition-colors">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter">
              ...
              <div className="md:col-span-2 group pillar-card bg-surface-container-low p-10 rounded-xl border border-outline-variant/20 hover:border-primary/20 transition-all">
                <div className="flex flex-col h-full justify-between gap-12">
                  <div className="flex justify-between items-start">
                    <span className="material-symbols-outlined pillar-icon text-primary text-display-lg transition-transform" data-icon="account_balance">account_balance</span>
              ...
              <div className="group pillar-card bg-primary text-white p-10 rounded-xl transition-all">
                <div className="flex flex-col h-full justify-between gap-12">
                  <div className="flex justify-between items-start">
                    <span className="material-symbols-outlined pillar-icon text-secondary text-display-lg transition-transform" data-icon="groups">groups</span>
              ...
              <div className="group pillar-card bg-surface-container-highest p-10 rounded-xl transition-all">
                <div className="flex flex-col h-full justify-between gap-12">
                  <div className="flex justify-between items-start">
                    <span className="material-symbols-outlined pillar-icon text-on-tertiary-container text-display-lg transition-transform" data-icon="history_edu">history_edu</span>
                ...
                <div className="flex flex-col md:flex-row gap-10 items-center">
                  <div className="w-full md:w-1/3">
                    <img 
                      ...
                      data-alt="A focused close-up shot of hands signing a formal document with a high-end fountain pen." 
                      src="https://lh3.googleusercontent.com/aida-public/AB6AXuChyhxbTLinqETCq9NSMdvnqIScl2K_r7HutjCvexWq-Cu2Z9fkqA0mLOtXJun1C6RYhDp_aBNRJ4WYZ5k3Y6N90karpHe1KSlcuR1ynIkoYj4nWz4B-1KE1djuop4lbFbVCEshrVDSu51utJhSMrUXY-g5hhGGA81txCwGI1xVtmsFr231h1UFnLRnFeceGcq8MQ_9gPmNA-AnM15dy8EUABuLtUG5Vh7YF62i0WDYiqLbWVn5nQZ6Vc8HTW6WDpLcCXAxzpwoO2aK"
                    />
                  </div>
          ...
          <section className="py-32 bg-cream overflow-hidden relative">
            <div className="absolute top-0 right-0 w-1/2 h-full opacity-5 pointer-events-none">
              <span className="material-symbols-outlined text-[40rem]" data-icon="account_balance">account_balance</span>
            </div>
