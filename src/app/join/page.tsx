...
export default function JoinPage() {
  return (
    <AuthLayout>
      <div className="space-y-8 w-full max-w-md mx-auto px-margin-mobile md:px-margin-desktop">
        ...
        <form className="space-y-6">
          ...
          <div className="flex items-start gap-3 p-4 rounded-xl bg-accent/10 border border-accent/20 touch-manipulation">
          ...
          <Button variant="action" size="lg" className="w-full py-6 active:scale-95 transition-transform touch-manipulation">
            Create Account
          </Button>
        </form>
        <div className="text-center">
          <Typography variant="body-sm" className="text-neutral/60">
            Already a member? <Link href="/auth/login" className="text-primary font-bold hover:underline touch-manipulation">Login here</Link>
          </Typography>
        </div>
      </div>
    </AuthLayout>
