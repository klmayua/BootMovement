         ...
         <section className="grid grid-cols-12 gap-6 mb-20">
           ...
           <section className="mb-20 bg-surface-container-low rounded-2xl p-10 border border-outline-variant/30 flex flex-col md:flex-row gap-12 items-center">
             <div className="flex-1 text-center md:text-left">
               ...
               <div className="mt-10">
                 <button className="bg-primary text-on-primary px-8 py-3 font-label-lg text-label-lg rounded-DEFAULT hover:bg-primary-container transition-colors touch-manipulation">
                   Find a Chapter
                 </button>
               </div>
             </div>
