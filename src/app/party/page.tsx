      ...
      <header className="w-full sticky top-0 z-50 bg-surface border-b border-outline-variant/30 px-margin-desktop py-4 flex justify-between items-center transition-all duration-300">
        <div className="flex items-center gap-8">
          ...
          <nav className="hidden md:flex gap-6">
            <Link className="text-on-surface-variant hover:text-primary hover:bg-surface-container-low transition-all font-label-lg text-label-lg px-1 py-1 rounded-md active:scale-95" href="/party/manifesto">Manifesto</Link>
            <Link className="text-on-surface-variant hover:text-primary hover:bg-surface-container-low transition-all font-label-lg text-label-lg px-1 py-1 rounded-md active:scale-95" href="/party/thesis">The Thesis</Link>
            <Link className="text-on-surface-variant hover:text-primary hover:bg-surface-container-low transition-all font-label-lg text-label-lg px-1 py-1 rounded-md active:scale-95" href="/party/leadership">Leadership</Link>
            <Link className="text-on-surface-variant hover:text-primary hover:bg-surface-container-low transition-all font-label-lg text-label-lg px-1 py-1 rounded-md active:scale-95" href="/party/newsroom">Newsroom</Link>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link href="/party/login" className="bg-secondary text-on-secondary px-6 py-2 font-label-lg text-label-lg hover:opacity-90 active:scale-95 transition-all">Sign In</Link>
            </div>
          </div>
      </header>
