    ...
    <PublicLayout>
      <div className="flex flex-col min-h-screen">
        <main className="max-w-container-max mx-auto">
          ...
          <section className="px-margin-mobile md:px-margin-desktop py-24 grid grid-cols-1 lg:grid-cols-12 gap-gutter items-center">
            <div className="lg:col-span-7">
              ...
              <div className="flex gap-6">
                ...
                <button className="border border-tertiary-container text-tertiary-container px-8 py-4 rounded-full font-label-lg text-label-lg hover:bg-tertiary-fixed transition-all">
                  The Manifesto
                </button>
              </div>
            </div>
            <div className="lg:col-span-5 relative">
              <div className="aspect-[4/5] rounded-xl overflow-hidden border border-tertiary-fixed/30">
              ...
              <div className="absolute -bottom-10 -left-10 p-8 bg-surface-container-highest border border-tertiary-fixed/30 rounded-xl max-w-xs shadow-sm">
          ...
          <section className="px-margin-mobile md:px-margin-desktop py-24 bg-surface-container-low">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter h-auto md:h-[600px]">
              <div className="col-span-1 row-span-2 p-10 bg-surface rounded-xl border border-tertiary-fixed/30 flex flex-col justify-between">
                <div>
              ...
              <div className="col-span-2 p-10 bg-primary-container text-on-primary-container rounded-xl flex items-center gap-12 overflow-hidden relative">
              ...
              <div className="col-span-1 p-10 bg-surface rounded-xl border border-tertiary-fixed/30">
